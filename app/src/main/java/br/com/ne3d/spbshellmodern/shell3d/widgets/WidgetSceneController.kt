...
class WidgetSceneController<S : WidgetSnapshot>(private val scene: WidgetScene, private val source: WidgetDataSource<S>, private val onAnimationChanged: (Boolean) -> Unit) {
    ...
    fun onSnapshotPublished(invalidateOnce: () -> Unit) { if(!released) invalidateOnce() }

...
class ShellRenderer(
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        engine.state.panels.forEach { panel ->
            ...
            GLES30.glUniformMatrix4fv(matrix,1,false,mvp,0); GLES30.glUniform1i(mirrorPassLocation,1); GLES30.glUniform1f(alpha,transform.alpha * .30f); GLES30.glActiveTexture(GLES30.GL_TEXTURE0); GLES30.glBindTexture(GLES30.GL_TEXTURE_2D,textures.textureId(panel.id)); GLES30.glUniform1i(texture,0); panel.renderMesh.indices.position(0); GLES30.glDrawElements(GLES30.GL_TRIANGLES,panel.renderMesh.indexCount,GLES30.GL_UNSIGNED_SHORT,panel.renderMesh.indices); drawn++
        }
        GLES30.glDisableVertexAttribArray(position); GLES30.glDisableVertexAttribArray(uv)

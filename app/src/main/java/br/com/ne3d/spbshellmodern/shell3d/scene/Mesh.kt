...
class Mesh(override val vertices: FloatBuffer, override val indices: ShortBuffer, override val vertexCount: Int, override val indexCount: Int, override val strideBytes: Int = MeshVertexLayout.STRIDE_BYTES) : RenderMesh
